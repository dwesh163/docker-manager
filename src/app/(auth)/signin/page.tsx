...
function LoginForm() {
	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		await signIn('credentials', {
			email,
			password,
			callbackUrl: 'https://manager.kooked.ch',
		});
	};
				...
				<CardContent className="pt-0 sm:px-6 px-3">
					<div className="pt-0 grid gap-4">
						<div className="grid grid-cols-2 gap-6">
							<Button variant="outline" onClick={() => signIn('github', { callbackUrl: 'https://manager.kooked.ch' })}>
							...
							<Button variant="outline" onClick={() => signIn('google', { callbackUrl: 'https://manager.kooked.ch' })}>
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="mr-2 h-4 w-4 text-white dark:text-white" viewBox="0 0 16 16">
